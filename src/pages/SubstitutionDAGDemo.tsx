...
const TRY_SUB_EXAMPLES: TrySubExample[] = [
  ...
  {
    name: 'Op chain commutativity (non-branch)',
    targetLeft: ', 1 \\Od 2, 2 \\Oc 3,',
    targetRight: ', 1 \\Od 2, 3 \\Oc 2,',
    ruleLeft: ', i \\Od j, j \\Oc k,',
    ruleRight: ', i \\Od j, k \\Oc j,',
    description: 'Replace j\\Oc k with k\\Oc j in the chain.',
  },
  {
    name: 'Branch identity',
    targetLeft: ', \\Bb{1 \\Oe 2}{,1 \\Op,}{, 1 \\Op, },',
    targetRight: ', \\Bb{1 \\Oe 2}{,1 \\Op,}{, 1 \\Op, },',
